    ...
    return (
        <div className='w-full pb-4'>
            ...
            <div className='w-full flex items-center justify-start min-[321px]:justify-end mt-2 gap-1'>
                <SelectInput className={"md:w-5/12 md:h-9"} setOption={getOptionPeriodo} setValue={setSelectOptionEnable} options={optionsEnable} title='Habilitado para' titleEnter={false}>
            ...
            <TableShedule setBottonEdit={openModalTableEdit} headValue={headValue} valueCell={infoCell}></TableShedule>
            ...
            <Modal show={showTableNew} onDisable={closeModalTable} aceptModal={false} fullScreen={true}>
                <div className='w-full px-2 py-4'>
                    ...
                    <TableShedule options={{ carrer: optionsCarrer, smt: optionsSemester, period: optionsPeriod }} setHeadValue={setHeadValue} closeTable={closeModalTable} saveTable={saveTable} edit={true} updateTable={tableAccion.update} newTable={tableAccion.new} headValue={headValue} valueCell={infoCell} setValueCell={setInfoCell}></TableShedule>
                </div>
            </Modal>
        </div>
    )
