export const routes = {
  ...
  assistance: {
    ...
    title: "Asistencias",
    svg: {
      filled: `<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="size-6 bi bi-person-fill-check" viewBox="0 0 16 16">
  <path d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7m1.679-4.493-1.335 2.226a.75.75 0 0 1-1.174.144l-.774-.773a.5.5 0 0 1 .708-.708l.547.548 1.17-1.951a.5.5 0 1 1 .858.514M11 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0"/>
  <path d="M2 13c0 1 1 1 1 1h5.256A4.5 4.5 0 0 1 8 12.5a4.5 4.5 0 0 1 1.544-3.393Q8.844 9.002 8 9c-5 0-6 3-6 4"/>
</svg>`,
      outline: `<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="size-6 bi bi-person-check" viewBox="0 0 16 16" stroke-width="0.1">
  ...
  <path d="M4.462 19.462c.42-.419.753-.89 1-1.395.453.214.902.435 1.347.662a6.742 6.742 0 0 1-1.286 1.794.75.75 0 0 1-1.06-1.06Z" />F</svg>`,
      outline: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
  ...
  matricule: {
    ...
    svg: {
      ...
      outline: `<svg xmlns="http://www.w3.org/2000/svg" class="size-6" viewBox="0 -960 960 960" fill="currentColor">
...
export const routeForRole = {
  alumno: [
    ...
    {
      name: routes.assistance.title,
      url: routes.assistance.url,
      svg: routes.assistance.svg
    },
    {
