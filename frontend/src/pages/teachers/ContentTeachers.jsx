...
function ContentTeachers() {
    const [searchPersonal, setSearchPersonal] = useState("")
    const [filtreSelect, setFiltreSelect] = useState("")
    const [optionsPersonal, setOptionsPersonal] = useState([{ id: 0, nombre: "Jhoana Lizbeth", apellidos: "Yañez Villanueva", correo: "jhoana@gmail.com", telefono: "735231201" }, { id: 1, nombre: "a", apellidos: "a", correo: "a@gmail.com", telefono: "735231201" }, { id: 2, nombre: "b", apellidos: "b", correo: "cb@gmail.com", telefono: "735231201" }])
            ...
            <div>
                <div className="w-full flex justify-between mt-4">
                    <div className="flex md:gap-5 justify-start gap-0.5 w-9/12">
                        ...
                        <InputSearch valueSearch={"nombre"} className={"md:w-1/2 md:h-11"} getOptions={getPersonal} options={optionsPersonal} value={searchPersonal} setValue={setSearchPersonal} title="Buscar personal" />
                    </div>
                        ...
                        optionsPersonal.length > 0
                            ...
                            <>
                                ...
                                <div className='flex flex-col visible md:hidden'>
                                    {
                                        optionsPersonal.map((option) => (
                                            <CardPersonal info={["correo","telefono"]} key={option.id} item={option} index={option.id} onClickDelete={showModalDelete} indexDelete={indexDelete} deleteAprob={deleteAprob} />
                                        ))
                                    }
                                </div>
                            </>
